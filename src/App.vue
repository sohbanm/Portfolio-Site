<template> 
  <v-app id="main"> 
    ...
    <!-- This is where all the components are being called in -->
...
export default {
  data: () => ({ 
    items: [
      ...
      {id: 5, title: 'Resume', icon: 'mdi-file-account', ref: "https://drive.google.com/file/d/1MgjgdrBJbOCEQz2pj3XMInxbHpq0lLpR/view?usp=share_link"}
    ],
    icons: [
